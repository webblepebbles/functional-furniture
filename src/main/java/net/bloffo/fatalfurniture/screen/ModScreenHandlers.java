...
public class ModScreenHandlers {
    public static final ScreenHandlerType<DrawersScreenHandler> DRAWERS_SCREEN_HANDLER = Registry.register(
            Registries.SCREEN_HANDLER, Identifier.of(FatalFurniture.MOD_ID, "drawers_screen_handler"),
